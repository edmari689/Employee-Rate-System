...
Public Class Form5
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        loadSqlConnection()
        Dim SQLStatement As String = "INSERT INTO rater(name, position, unit_department, supervisor) VALUES ('" & TextBox2.Text & "', '" & TextBox3.Text & "', '" & TextBox4.Text & "', '" & TextBox5.Text & "')"
    ...
    Public Sub LoadListView()
        ...
        Dim SQLStatement As String = "select * from rater"
        Dim cmd As MySqlCommand = New MySqlCommand
    ...
    Private Sub ListView1_MouseClick(sender As Object, e As MouseEventArgs) Handles ListView1.MouseClick
        ...
        For Each LItem In LItems
            ...
            TextBox5.Text = LItem.SubItems(4).Text
    ...
    Private Sub autoComplete()
        loadSqlConnection()
        Dim SQLStatement As String = "select name from rater"
        Dim cmd As MySqlCommand = New MySqlCommand
        Dim myAdapter As New MySqlDataAdapter
        Dim myData As New DataTable
        Dim i As Integer
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        loadSqlConnection()
        Dim SQLStatement As String = "update rater set name = '" & TextBox2.Text & "', position = '" & TextBox3.Text & "', unit_department = '" & TextBox4.Text & "', supervisor = '" & TextBox5.Text & "' where id = " + TextBox1.Text + " "
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        loadSqlConnection()
        Dim SQLStatement As String = "delete from rater where id = " + TextBox1.Text + " "
